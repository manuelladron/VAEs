...
class Generator_poor(Net):

    def __init__(self, z_dim):
        super(Generator_poor, self).__init__()
        
        
        self.net1 = nn.Sequential(
            nn.Linear(in_features=z_dim, out_features=8*8*16),
            nn.LeakyReLU(negative_slope=0.2),
        )
        
        self.net2 = nn.Sequential(
            Reshape(shape=(-1, 16, 8, 8)), # 8 pixels 
            nn.BatchNorm2d(num_features=16),
            nn.ConvTranspose2d(in_channels=16, out_channels=3,
                               kernel_size=6, stride=4, padding=1), # 32 pixels 
...
class Generator_good(Net):

    def __init__(self, z_dim):
        super(Generator_good, self).__init__()
...
class Generator_bad(Net):

    def __init__(self, z_dim):
        super(Generator_bad, self).__init__()
...
class Generator_mid(Net):

    def __init__(self, z_dim):
        super(Generator_mid, self).__init__()
